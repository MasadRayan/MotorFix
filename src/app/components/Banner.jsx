...
const slides = [
    {
        ...
        desc: "There are many variations of passages available, but the majority have suffered alteration in some form.",
    ...
    {
        id: 6,
        title: "Expert Mechanics For Your Car",
        desc: "There are many variations of passages available, but the majority have suffered alteration in some form.",
    ...
    return (
        <div className="relative">
            ...
            <Swiper
                ...
                onSwiper={(swiper) => {
                    // Delay to avoid null refs on init
                    setTimeout(() => {
                    ...
                    <SwiperSlide key={slide.id}>
                        <div className="relative">
                            <Image
                                ...
                                width={1200}
                                height={600}
                                className="w-full h-80 md:h-96 lg:h-[550px] object-fill rounded-2xl"
                            />
                            <div className="absolute inset-0 bg-black/50 rounded-2xl"></div>
                            <div className="absolute top-1/2 md:top-70 left-1/2 md:left-130 transform -translate-x-1/2 -translate-y-1/2 px-4 text-center md:text-left">
                                ...
                                <div className="flex justify-center md:justify-start items-center gap-3 md:gap-5 mt-4 md:mt-6">
                                    <button className="btn bg-[#FF3811] text-white border-0 hover:scale-105 transition-all">
                                        Discover More
                                    </button>
                                    <button className="btn btn-outline text-white hover:bg-[#FF3811] hover:text-white hover:scale-105 transition-all">
                                        Latest Project
                                    </button>
                                </div>
                            </div>
